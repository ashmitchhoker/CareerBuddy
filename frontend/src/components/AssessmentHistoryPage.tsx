...
const translations = {
  en: {
    ...
    deleteDescription:
      "Are you sure you want to delete this assessment? This will permanently delete the assessment, all test responses, and chat history. This action cannot be undone.",
    deleteButton: "Delete",
    cancel: "Cancel",
    deleting: "Deleting...",
    at: "at",
  ...
  hi: {
    ...
    deleteDescription:
      "क्या आप वाकई इस मूल्यांकन को हटाना चाहते हैं? यह मूल्यांकन, सभी परीक्षण प्रतिक्रियाएं और चैट इतिहास को स्थायी रूप से हटा देगा। इस क्रिया को पूर्ववत नहीं किया जा सकता।",
    deleteButton: "हटाएं",
    cancel: "रद्द करें",
  ...
  te: {
    ...
    deleteDescription:
      "మీరు నిజంగా ఈ అసెస్‌మెంట్‌ను తొలగించాలనుకుంటున్నారా? ఇది అసెస్‌మెంట్, అన్ని పరీక్ష ప్రతిస్పందనలు మరియు చాట్ చరిత్రను శాశ్వతంగా తొలగిస్తుంది. ఈ చర్యను రద్దు చేయలేరు.",
  ...
  ta: {
    ...
    deleteDescription:
      "இந்த மதிப்பீட்டை நீக்க விரும்புகிறீர்களா? இது மதிப்பீடு, அனைத்து சோதனை பதில்கள் மற்றும் அரட்டை வரலாற்றை நிரந்தரமாக நீக்கும். இந்த செயலை மீளமுடியாது.",
    deleteButton: "நீக்கு",
    cancel: "ரத்துசெய்",
  ...
  bn: {
    ...
    deleteDescription:
      "আপনি কি নিশ্চিত যে আপনি এই মূল্যায়নটি মুছতে চান? এটি মূল্যায়ন, সমস্ত পরীক্ষার প্রতিক্রিয়া এবং চ্যাট ইতিহাস স্থায়ীভাবে মুছে ফেলবে। এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।",
    deleteButton: "মুছুন",
    cancel: "বাতিল",
    deleting: "মুছে ফেলছে...",
    at: "এ",
  ...
  gu: {
    ...
    deleteDescription:
      "શું તમે ખરેખર આ મૂલ્યાંકન કાઢી નાખવા માંગો છો? આ મૂલ્યાંકન, બધી પરીક્ષણ પ્રતિસાદો અને ચેટ ઇતિહાસને કાયમી રીતે કાઢી નાખશે. આ ક્રિયાને પૂર્વવત્ કરી શકાતી નથી.",
...
export function AssessmentHistoryPage({
    ...
    const refreshAssessments = async () => {
      ...
      try {
        ...
        if (data.completed_assessments) {
          ...
          const assessments = data.completed_assessments.map((a: any) => ({
            id: a.id,
  ...
  const formatDate = (date: Date) => {
    return new Intl.DateTimeFormat(
      userProfile.language === "en" ? "en-US" : "en-IN",
      {
        year: "numeric",
        month: "short",
        day: "numeric",
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          {t.completedOn} {formatDate(assessment.completedAt)}{" "}
                          {t.at} {formatTime(assessment.completedAt)}
                        </p>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                      <Button
                        onClick={() =>
                          navigateTo("chatbot", true, assessment.id)
                        }
