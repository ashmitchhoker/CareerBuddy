...
const translations = {
  en: {
    ...
    aptitudeTitle: 'Aptitude Assessment',
    aptitudeDesc: 'Discover your natural abilities and strengths across different skill areas',
    ...
    cancel: 'Cancel',
    aptitudeInstruction: "You'll now answer a few short statements to help us understand what kinds of activities and subjects you enjoy.\n\nFor each one, choose how much you agree — from Strongly Disagree to Strongly Agree.\n\nThere are no right or wrong answers, just what feels true for you.\n\nYour responses will help us suggest careers that fit your strengths and interests.",
  ...
  hi: {
    ...
    aptitudeTitle: 'योग्यता मूल्यांकन',
    aptitudeDesc: 'विभिन्न कौशल क्षेत्रों में अपनी प्राकृतिक क्षमताओं और शक्तियों की खोज करें',
    ...
    cancel: 'रद्द करें',
    aptitudeInstruction: "अब आप कुछ छोटे कथनों का उत्तर देंगे जो हमें यह समझने में मदद करेंगे कि आप किस प्रकार की गतिविधियों और विषयों का आनंद लेते हैं।\n\nप्रत्येक के लिए, चुनें कि आप कितना सहमत हैं — पूरी तरह असहमत से पूरी तरह सहमत तक।\n\nकोई सही या गलत उत्तर नहीं हैं, बस जो आपके लिए सच लगता है।\n\nआपकी प्रतिक्रियाएं हमें ऐसे करियर सुझाने में मदद करेंगी जो आपकी शक्तियों और रुचियों से मेल खाते हैं।",
  ...
  te: {
    ...
    aptitudeTitle: 'ఆప్టిట్యూడ్ అసెస్‌మెంట్',
    aptitudeDesc: 'వివిధ నైపుణ్య రంగాలలో మీ సహజ సామర్థ్యాలు మరియు బలాలను కనుగొనండి',
    ...
    cancel: 'రద్దు చేయి',
    aptitudeInstruction: "మీరు ఏ రకమైన కార్యకలాపాలు మరియు విషయాలను ఆనందిస్తారో అర్థం చేసుకోవడానికి మీరు ఇప్పుడు కొన్ని చిన్న ప్రకటనలకు సమాధానం ఇస్తారు।\n\nప్రతి దాని కోసం, మీరు ఎంతగా అంగీకరిస్తారో ఎంచుకోండి — పూర్తిగా అంగీకరించను నుండి పూర్తిగా అంగీకరిస్తున్నాను వరకు।\n\nసరైన లేదా తప్పు సమాధానాలు లేవు, మీకు నిజం అనిపించేది మాత్రమే।\n\nమీ ప్రతిస్పందనలు మీ బలాలు మరియు ఆసక్తులకు సరిపోయే కెరీర్‌లను సూచించడంలో మాకు సహాయపడతాయి।",
  ...
  ta: {
    ...
    aptitudeTitle: 'திறன் மதிப்பீடு',
    aptitudeDesc: 'பல்வேறு திறன் பகுதிகளில் உங்கள் இயல்பான திறன்கள் மற்றும் பலங்களைக் கண்டறியவும்',
    ...
    cancel: 'ரத்து செய்',
    aptitudeInstruction: "நீங்கள் எந்த வகையான செயல்பாடுகள் மற்றும் பாடங்களை அனுபவிக்கிறீர்கள் என்பதைப் புரிந்துகொள்ள சில சிறிய அறிக்கைகளுக்கு நீங்கள் இப்போது பதிலளிப்பீர்கள்।\n\nஒவ்வொன்றிற்கும், நீங்கள் எவ்வளவு ஒப்புக்கொள்கிறீர்கள் என்பதைத் தேர்வுசெய்க — முற்றிலும் உடன்படவில்லை முதல் முற்றிலும் ஒப்புக்கொள்கிறேன் வரை।\n\nசரியான அல்லது தவறான பதில்கள் இல்லை, உங்களுக்கு உண்மை என்று தோன்றுவதுதான்।\n\nஉங்கள் பதில்கள் உங்கள் பலங்கள் மற்றும் ஆர்வங்களுக்கு பொருந்தும் தொழில்களை பரிந்துரைக்க உதவும்।",
  ...
  bn: {
    ...
    aptitudeTitle: 'অ্যাপটিটিউড অ্যাসেসমেন্ট',
    aptitudeDesc: 'বিভিন্ন দক্ষতা ক্ষেত্রে আপনার প্রাকৃতিক ক্ষমতা এবং শক্তি আবিষ্কার করুন',
    ...
    cancel: 'বাতিল করুন',
    aptitudeInstruction: "আপনি কি ধরনের কার্যকলাপ এবং বিষয় উপভোগ করেন তা বুঝতে সাহায্য করার জন্য আপনি এখন কিছু সংক্ষিপ্ত বিবৃতির উত্তর দেবেন।\n\nপ্রতিটির জন্য, আপনি কতটা সম্মত তা চয়ন করুন — সম্পূর্ণভাবে অসম্মত থেকে সম্পূর্ণভাবে সম্মত পর্যন্ত।\n\nকোনো সঠিক বা ভুল উত্তর নেই, শুধু যা আপনার কাছে সত্য মনে হয়।\n\nআপনার প্রতিক্রিয়া আমাদের এমন ক্যারিয়ার সুপারিশ করতে সাহায্য করবে যা আপনার শক্তি এবং আগ্রহের সাথে মানানসই।",
  ...
  gu: {
    ...
    aptitudeTitle: 'એપ્ટિટ્યુડ એસેસમેન્ટ',
    aptitudeDesc: 'વિવિધ કુશળતા ક્ષેત્રોમાં તમારી કુદરતી ક્ષમતાઓ અને શક્તિઓ શોધો',
    ...
    cancel: 'રદ કરો',
    aptitudeInstruction: "તમે હવે કેટલાક ટૂંકા નિવેદનોના જવાબ આપશો જે અમને સમજવામાં મદદ કરશે કે તમે કેવા પ્રકારની પ્રવૃત્તિઓ અને વિષયોનો આનંદ માણો છો।\n\nદરેક માટે, તમે કેટલા સહમત છો તે પસંદ કરો — સંપૂર્ણપણે અસહમત થી સંપૂર્ણપણે સહમત સુધી।\n\nકોઈ સાચા કે ખોટા જવાબો નથી, ફક્ત તમારા માટે જે સાચું લાગે છે તે।\n\nતમારા પ્રતિભાવો અમને તમારી શક્તિઓ અને રુચિઓને અનુરૂપ કારકિર્દી સૂચવવામાં મદદ કરશે।",
